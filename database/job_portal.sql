...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 15, 2026 at 07:47 AM
...
(13, 17, 27, '2026-07-14 08:23:29', 'pending', 1);
...
CREATE TABLE `jobs` (
  ...
  `job_type` enum('Full Time','Part Time','Internship','Contract','Remote','Hybrid') NOT NULL DEFAULT 'Full Time'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
(17, 3, 'Umar', 'Aptech', 'multan', '50000', 'i am software engineer', '2026-06-05 13:44:58', 5, 'open', 'Full Time'),
(20, 27, 'Finance & Banking', 'Ahmed Company  ', 'Multan ', '50000 ', '   Core Roles: Accountant, Financial Analyst, Internal Auditor, Accounts Officer.Leadership: Finance Manager, Wealth Manager, Chief Financial Officer (CFO).   ', '2026-07-14 06:39:43', 6, 'open', 'Part Time');
...
CREATE TABLE `users` (
  ...
  `company_founded_year` year(4) DEFAULT NULL,
...
INSERT INTO `users` (`id`, `fullname`, `profile_image`, `email`, `password`, `role`, `bio`, `skills`, `experience`, `cv_file`, `created_at`, `company_name`, `company_logo`, `company_website`, `company_email`, `company_phone`, `company_industry`, `company_size`, `company_founded_year`, `company_city`, `company_address`, `company_about`, `company_linkedin`) VALUES
...
(3, 'Syed Abbas Ansari', '1783300971Screenshot (95).png', 'umar@gmail.com', '$2y$10$MD9svgK9fmxAcsiuhxx.CepCuJJJaLy3wZIh.B93K.JPcuhjN28T.', 'employer', 'i am abbas ansari', 'Adboe Photoshop', '2 years', '1783300971Screenshot (96).png', '2026-07-13 10:53:13', 'Sara Company', 'company_3_1783939936.png', 'https://job-portal.infinityfreeapp.com', 'mu160446@gmail.com', '03345494892', 'high five', '250+ employers', '2016', 'karachi', 'S2/520 Saudabad Malir Karachi', 'Sara Company is good', 'https://pk.linkedin.com'),
